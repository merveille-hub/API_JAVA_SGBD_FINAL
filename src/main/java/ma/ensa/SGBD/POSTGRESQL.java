...
public class POSTGRESQL implements RequetesSGBD {
    ...
    public POSTGRESQL() throws SQLException, IOException {
        this.connection = getConnection();
    }

    /**Se connecter à la base de données definis dans le fichier de configuration*/
    public Connection getConnection() throws IOException, SQLException {
        return PropertiesReader.connectFromProperties("dbPostgreSql.properties");
    }
